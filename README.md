...
1. Nexus на машину установлен
![image6](img/zadanie3/03_01.png)
2. raw-hosted репозиторий создан
3. файл типа GO создается
![image7](img/zadanie3/03_02.png)
![image8](img/zadanie3/03_03.png)
4. Файл загружен в репозиторий средствами Jenkins
![image9](img/zadanie3/04_03.png)
![image10](img/zadanie3/05_03.png)
